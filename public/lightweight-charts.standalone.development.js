    ...
    ***************************************************************************** */
    ...
    var TimeAxisViewRenderer = /** @class */ (function () {
        ...
        TimeAxisViewRenderer.prototype._internal_setData = function (data) {
            // LOOK HERE
            // console.log(data._internal_text)
            this._private__data = data;
            // window.time = data._internal_text;
            window.proxy.time = data._internal_text;
        };
    ...
    var TimeScale = /** @class */ (function () {
        ...
        TimeScale.prototype._internal_formatDateTime = function (time) {
            ...
            let test = this._private__dateTimeFormatter._internal_format(new Date(time._internal_timestamp * 1000));
            // console.log(time._internal_timestamp)
            let date = new Date(time._internal_timestamp * 1000);
            // console.log(`TEST: ${date.toLocaleString('en-US', { hour12: true, month: 'long', day: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric', secondsVisible: false })}`)
            // console.log(`TEST: ${date.toLocaleString('en-US')}`)
            // test = date.toLocaleString('en-US'))
            test = date.toLocaleString('en-US', { hour12: true, month: 'long', day: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric', secondsVisible: false, timeZone: 'UTC' })
            return test
            // look here
        };
